...
data class SettingsUiState(
    ...
    val onChangeTavilyApiKey: (String) -> Unit = {},
    val braveApiKey: String = "",
    val onChangeBraveApiKey: (String) -> Unit = {},
    val serpApiKey: String = "",
    val onChangeSerpApiKey: (String) -> Unit = {},
    val exaApiKey: String = "",
    val onChangeExaApiKey: (String) -> Unit = {},
    val gitHubToken: String = "",
    val onChangeGitHubToken: (String) -> Unit = {},
    val firecrawlApiKey: String = "",
    val onChangeFirecrawlApiKey: (String) -> Unit = {},
    val soulText: String = "",
